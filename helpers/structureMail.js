const consultant = (content) =>{
    const {id_seller} = content;
    let contentHTML =`
    <!DOCTYPE html
                                    ...
                                    <td align="center" height="70" style="height:70px;">
                                        <a href=""
                                            style="display: block; border-style: none !important; border: 0 !important;"><img
                                                ...
                                                src="https://res.cloudinary.com/no-country/image/upload/v1646847617/my_upload/prueba_dlparj.png"
                                                alt="" /></a>
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                La consulta se entregó con éxito
                        ...
                        <td align="center" class="section-img">
                            <a href=""
                                style=" border-style: none !important; display: block; border: 0 !important;"><img
                                    src="https://res.cloudinary.com/no-country/image/upload/v1646845951/my_upload/TickIcon2_l5hqdo.png"
                                    style="display: block; width: 250px; height: 250px;" width="590" height="250"
                                    border="0" alt="" /></a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod tempora iusto
                                            itaque iste consectetur inventore porro minus quaerat mollitia nobis, vero
                                            maxime labore accusantium natus, qui officia ullam id cupiditate.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center"
                            style="color: #343434; font-size: 16px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            class="main-header">


                            <div style="line-height: 35px">

                                ¿Quéres ver mas sobre el artista?
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0"
                                bgcolor="5caad2" style="background-color: #F1E6DE;">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="https://c3-g62-i1p8l14p5-mendietasergio.vercel.app/api/users/${id_seller}" style="color: #000; text-decoration: none;">Ver su perfil</a>
                                        </div>
                                    </td>
                                </tr>
...
const seller = (content) => {
    let {id_consultant, nombreConsultant, emailConsultant, phone, id_producto, nombre_autor} = content;
    let contentHTML = `
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="200" height="200" border="0" style="display: block; width: 250px; height: 200px;" src="https://res.cloudinary.com/no-country/image/upload/v1646847617/my_upload/prueba_dlparj.png" alt="" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="color: #343434; font-size: 20px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                                        class="main-header">
            
            
                                        <div style="font-size: 20px">
            
                                            Hola <span style="font-size: 25px">${nombre_autor}!</span> Tenes una consulta sobre tu obra
            ...
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    <tr>
                        ...
                        <td align="center" class="section-img">
                            <a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="https://res.cloudinary.com/no-country/image/upload/v1646845958/my_upload/campana_xz20fn.png" style="display: block; width: 200px; height: 150px;" width="200" height="150" border="0" alt="" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td height="20" style="font-size: 20px; line-height: 20px;">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px; text-align: left;">
                                            ...
                                            @Email: ${emailConsultant}
                                        </div>
                                        <div style="line-height: 24px; text-align: left;">

                                            @Producto: <a href="https://c3-g62-i1p8l14p5-mendietasergio.vercel.app/api/products/detail/${id_producto}" style="color: #000; text-decoration: none;">Ver Producto</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0" bgcolor="5caad2" style="background-color: #F1E6DE;">
                                ...
                                <tr>
                                    <td align="center" style="color: #F1E6DE; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">


                                        <div style="line-height: 26px;">
                                            <a href="https://c3-g62-i1p8l14p5-mendietasergio.vercel.app/api/users/${id_consultant}" style="color: #000; text-decoration: none;">Ver perfil</a>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td>
                            <table border="0" width="300" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                        class="text_color">
                            ...
                            <table border="0" width="200" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                class="container590">
